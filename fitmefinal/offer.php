				...
				<div class="container">
					...
					<div class="main-navigation pull-right">
						...
						<ul class="menu">
							...
							<li class="menu-item current-menu-item"><a href="offer.php">My offer</a></li>
			...
			<main class="main-content">
				...
				<div class="content">
					<div class="container">
						...
						<h2 class="entry-title">Accusamus iusto odio dignissimos ducimus qui blanditiis praesentium deleniti corrupti quos dolores</h2>
						...
						<div class="row">
							<div class="col-md-3">
								<div class="feature color-purple">
									<div class="feature-icon"><i class="icon-bowl"></i></div>
									<h3 class="feature-title">Lorem ipsum</h3>
									<p>Pellentesque erat erat mattis feugiat pharetra, viverra nec mauris. Nullam sed risus aliquam congue nunc ac convallis mi. </p>
								</div>
							</div>
							<div class="col-md-3">
								<div class="feature color-green">
									<div class="feature-icon"><i class="icon-oil"></i></div>
									<h3 class="feature-title">Tempora incidunt</h3>
									<p>Pellentesque erat erat mattis feugiat pharetra, viverra nec mauris. Nullam sed risus aliquam congue nunc ac convallis mi. </p>
								</div>
							</div>
							<div class="col-md-3">
								<div class="feature color-pink">
									<div class="feature-icon"><i class="icon-honey"></i></div>
									<h3 class="feature-title">Cupidatat proident</h3>
									<p>Pellentesque erat erat mattis feugiat pharetra, viverra nec mauris. Nullam sed risus aliquam congue nunc ac convallis mi. </p>
								</div>
							</div>
							<div class="col-md-3">
								<div class="feature color-orange">
									<div class="feature-icon"><i class="icon-chocolate"></i></div>
									<h3 class="feature-title">Aliquam quaerat</h3>
									<p>Pellentesque erat erat mattis feugiat pharetra, viverra nec mauris. Nullam sed risus aliquam congue nunc ac convallis mi. </p>
								</div>
							</div>
						</div>
